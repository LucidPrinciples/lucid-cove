...
def create_app() -> FastAPI:
    ...
    from src.dashboard.routes import core, chat, memory, tuning, tuning_request, system, logs, runbooks, vault, youtube, youtube_auth, action_board, flow_chat, flow_cove, creation, presence, quick_list, projects, mirrors, mirror_builder, canon, settings, account, contact, nextcloud, files, home, jules, backlog, sites, agents, agent_provision, agent_presets, agent_dictate, video_pipeline, video_processing, x_posting, posting, matrix, matrix_spaces, haven, matrix_haven, registry, market, market_rates, provision_api, credits, profile, notify, onboarding, cost, hire, capabilities, domain, wake_thread, gpu_share, carry_import, pipeline_keys, compute, video_jobs, backup, jules_process, presence_invite, reachability, watcher, steward_queue

    all_routers = [core, chat, memory, tuning, tuning_request, system, logs, runbooks, vault, youtube, youtube_auth, action_board, flow_chat, flow_cove, creation, presence, quick_list, projects, mirrors, mirror_builder, canon, settings, account, contact, nextcloud, files, home, jules, backlog, sites, agents, agent_provision, agent_presets, agent_dictate, video_pipeline, video_processing, x_posting, posting, matrix, matrix_spaces, haven, matrix_haven, registry, market, market_rates, provision_api, credits, profile, notify, onboarding, cost, hire, capabilities, domain, wake_thread, gpu_share, carry_import, pipeline_keys, compute, video_jobs, backup, jules_process, presence_invite, reachability, watcher, steward_queue]
