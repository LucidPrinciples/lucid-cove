...
def create_app() -> FastAPI:
    ...
    if env_bool("LP_REGISTRY_MASTER"):
        _cove_only = {
            ...
            x_posting, posting, agents, agent_provision, agent_dictate, jules, gabs, model_lab, sites,
